...
WHERE park_id = (SELECT park_id FROM park WHERE name = 'Ohiopyle State Park');
...
VALUES (52, 'Wayne Family', '2023-08-14', '2023-08-24'), 
 (53, 'Parker Family', '2023-08-15', '2023-08-24'),
 (54, 'Kent Family', '2023-08-16', '2023-08-24');
 ...
 */
UPDATE reservation
SET from_date = '2023-08-04', to_date = '2023-08-11'
...
WHERE reservation_id = (SELECT reservation_id FROM reservation WHERE name = 'Kent Family' AND site_id = 54);
