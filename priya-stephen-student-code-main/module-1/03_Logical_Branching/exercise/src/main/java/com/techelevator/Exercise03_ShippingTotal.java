...
public class Exercise03_ShippingTotal {
    ...
    public double calculateShippingTotal(int weightPounds) {
        return (calculateShippingRate(weightPounds) * weightPounds);
    }
    ...
    public double calculateShippingTotal(int weightPounds, boolean hasDiscount) {
        ...
        if (hasDiscount) {
            newDiscountRate = ( 0.9 * calculateShippingTotal( weightPounds) );
            return newDiscountRate;
        } else {
           newDiscountRate = calculateShippingTotal( weightPounds);
           return newDiscountRate;
        }
    }
