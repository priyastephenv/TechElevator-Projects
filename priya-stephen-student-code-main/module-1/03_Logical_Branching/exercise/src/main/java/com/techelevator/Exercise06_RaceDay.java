...
public class Exercise06_RaceDay {
    ...
    public int getBibNumber(int age, int registrationNumber, boolean isEarlyRegistration) {
        int earlyBibNumber;
        int lateBibNumber;
        int earlyRegisterNumber = 1000;
        if (age >=18 && isEarlyRegistration) {
            earlyBibNumber = registrationNumber + earlyRegisterNumber;
            return earlyBibNumber;
        } else if (age >= 18 && !isEarlyRegistration) {
            lateBibNumber = registrationNumber;
            return lateBibNumber;
        } else {
            lateBibNumber = registrationNumber;
    ...
    public int getConfirmedBibNumber(int age, int registrationNumber, boolean isEarlyRegistration) {
        if ( (getBibNumber(age,registrationNumber, isEarlyRegistration))>1000 && !isEarlyRegistration) {
            return -1;
        }
